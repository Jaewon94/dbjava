...
<%@ include file="../header.jsp"%>
			...
			<div class="socialbox">
				<div id="kakaologin">
					<form method="POST" action="${cpath }/api/kakaosignup${not empty param.url ? url : ''}">
						...
						<button class="kakao">
							<img src="https://dbjava.s3.ap-northeast-2.amazonaws.com/essential/kakaoLogo.png"> 카카오 아이디로 로그인
						</button>
					</form>
				</div>
	...
	<script>
		...
		// kakaoLogin 변수
	 	...
	 	window.Kakao.init("98207e150ca73eba7ab071704182317f");     // kakao sdk 를 초기화 , 클라이언트 아이디 제공
		// naverLogin 변수
	  	var naver_id_login = new naver_id_login("sjcaVEYYkX9nK29CxFKi", "http://localhost:8090/dbjava_war/member/naver-login")    // 네이버 아이디 로그인을 위한 객체, 클라이언트 아이디, 로그인 후 리다이렉션 될 사용자 정보를 전달
